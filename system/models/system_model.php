...
class System_Model extends MVC_Model
{
    ...
    public function getReceivedCount($id)
    {
        ...
        $this->db->query("SELECT id FROM wa_received WHERE uid = ?", [
            $id
        ]);
    ...
    public function checkAiKey($uid, $id)
    {
        $this->db->query("SELECT id FROM ai_keys WHERE uid = ? AND id = ?", [
            $uid,
            $id
        ]);
    ...
    public function checkAiPlugin($uid, $id)
    {
        $this->db->query("SELECT id FROM ai_plugins WHERE uid = ? AND id = ?", [
            $uid,
            $id
        ]);
