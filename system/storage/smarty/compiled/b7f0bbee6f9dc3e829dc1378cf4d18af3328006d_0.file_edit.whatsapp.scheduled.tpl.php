<?php
/* Smarty version 5.4.3, created on 2025-01-23 18:21:15
  from 'file:dashboard/widgets/modals/edit.whatsapp.scheduled.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.3',
  'unifunc' => 'content_6792181b97bef2_01042271',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b7f0bbee6f9dc3e829dc1378cf4d18af3328006d' => 
    array (
      0 => 'dashboard/widgets/modals/edit.whatsapp.scheduled.tpl',
      1 => 1736441060,
      2 => 'file',
    ),
  ),
...
function content_6792181b97bef2_01042271 (\Smarty\Template $_smarty_tpl) {
...
?><form system-form>
 ...
 <i class="la la-info-circle" title="<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("and_edwhat_line17");?>
"></i>
                    </label>
                    <input type="text" name="name" class="form-control" placeholder="<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("and_edwhat_line19");?>
...
">
 ...
 <i class="la la-info-circle" title="<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("and_edwhat_line24");?>
"></i>
                    </label>
                    <input type="text" name="schedule" class="form-control" placeholder="<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("and_edwhat_line26");?>
...
"><?php echo $_smarty_tpl->getValue('data')['scheduled']['numbers'];?>
 ...
 <i class="la la-info-circle" title="<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("and_edwhat_line55");?>
"></i>
                    </label>
...
" <?php if ($_smarty_tpl->getSmarty()->getModifierCallback('in_array')(0,$_smarty_tpl->getSmarty()->getModifierCallback('split')($_smarty_tpl->getValue('data')['scheduled']['groups'],","))) {?>selected<?php }?>><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("form_select_multinone");?>
</option>
                        <?php
...
">
                    ...
                    <label class="mt-3">
                        <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("and_edwhat_line67");?>
 <i class="la la-info-circle" title="<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("and_edwhat_line67_1");?>
"></i>
                    </label>
...
" <?php if ($_smarty_tpl->getValue('data')['scheduled']['wid'] == $_smarty_tpl->getValue('account')['wid']) {?>selected<?php }?>><?php echo $_smarty_tpl->getValue('account')['name'];?>
</option>
                        <?php
...
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
 ...
 <i class="la la-info-circle" title="<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("and_edwhat_line76");?>
"></i>
                    </label>
...
" system-counter><?php echo $_smarty_tpl->getValue('data')['scheduled']['message'];?>
</textarea>
...
"></i>
 ...
 <i class="la la-info-circle" title="<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("and_edwhat_line103");?>
"></i>
                    </label>
        ...
        <div class="modal-footer">
            <button type="submit" class="btn btn-primary">
                <i class="la la-check-circle la-lg"></i> <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("and_edwhat_line116");?>
