<!DOCTYPE html>
<html lang="en" {if __s("language_rtl")}dir="rtl"{/if}>
...
<head>
    ...
    <link rel="stylesheet" href="{if __s("language_rtl")}{assets("css/libs/bootstrap.rtl.css")}{else}{assets("css/libs/bootstrap.css")}{/if}">
    <link rel="stylesheet" href="{assets("css/libs/plugins.css")}">
    <link rel="stylesheet" href="{if __s("language_rtl")}{assets("css/style.rtl.min.css")}{else}{assets("css/style.min.css")}{/if}">
