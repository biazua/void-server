        ...
        <div class="modal-body">
            <div class="form-row">
                <div class="form-group col-12">
                    <label>
                        {__("form_name")} <i class="la la-info-circle" title="{__("and_edit_role_line17")}"></i>
                    </label>
                    <input type="text" name="name" class="form-control" placeholder="{__("and_edit_role_line19")}" value="{$data.role.name}">
                </div>

                <div class="form-group col-12">
                    <label>
                        {__("form_permissions")} <i class="la la-info-circle" title="{__("and_edit_role_line24")}"></i>
                    </label>
