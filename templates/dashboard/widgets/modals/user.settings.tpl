        ...
        <div class="modal-body">
            <div class="form-row">
                <div class="form-group col-12">
                    <label>
                        {__("form_avatar")} <i class="la la-info-circle" title="{__("and_uset17")}"></i>
                    </label>
                ...
                <div class="form-group col-12">
                    <label>
                        {__("form_name")} <i class="la la-info-circle" title="{__("and_uset24")}"></i>
                    </label>
                    <input type="text" name="name" class="form-control" placeholder="{__("and_uset26")}" value="{$data.user.name}">
                </div>

                <div class="form-group col-12">
                    <label>
                        {__("form_emailaddress")} <i class="la la-info-circle" title="{__("and_uset31")}"></i>
                    </label>
                    <input type="text" name="email" class="form-control" placeholder="{__("and_uset33")}" value="{$data.user.email}">
                </div>
                ...
                <div class="form-group col-6">
                    <label>
                        {__("form_usertimezone")} <i class="la la-info-circle" title="{__("and_uset38")}"></i>
                    </label>
                ...
                <div class="form-group col-6">
                    <label>
                        {__("and_uset49")} <i class="la la-info-circle" title="{__("and_uset49_1")}"></i>
                    </label>
                ...
                <div class="form-group col-6">
                    <label>
                        {__("and_uset60")} <i class="la la-info-circle" title="{__("and_uset60_1")}"></i>
                    </label>
                ...
                <div class="form-group col-12">
                    <label>
                        {__("form_changepass")} <i class="la la-info-circle" title="{__("and_uset70")}"></i>
                    </label>
                    <input type="password" name="password" class="form-control" placeholder="{__("form_password_leave")}">
                </div>
