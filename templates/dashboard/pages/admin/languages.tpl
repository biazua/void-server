                ...
                <div class="row align-items-end">
                    <div class="col mb-2 mb-lg-0">
                        ...
                        <h1 class="header-title">
                            <i class="la la-language la-lg"></i> {__("dashboard_admin_tablanguagestitle")}
                        </h1>
                    </div>
                    <div class="col-auto">
                        <button class="btn btn-danger lift" title="{__("and_admin_lang_6")}" system-reorder>
                            <i class="la la-sort-alpha-up la-lg"></i>
                        </button>
                        <button class="btn btn-primary lift" system-toggle="add.language">
                            <i class="la la-language la-lg"></i> {__("dashboard_btn_addlanguage")}
                        </button>
                    </div>
                </div>
            </div>
